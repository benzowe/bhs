...
<script>
        $(document).ready(function(){
            $("i").toggle(
                function(){$("i.fas.fa-heart").css({"color": "lightpink"});},
                function(){$("").css({"color": "blue"});},
...
<table border="1"> 
    ...
    <tr class="w1">
        ...
        <td>
            ...
            <button style="background:lightcoral;padding:10px;border-radius:5px;" class="but">
                <i class="fas fa-plus" style="color:white"></i>
                <a href="" style="text-decoration:none;background:lightcoral;color:white; font-family:cursive">Add To Cart</a>
            ...
            <input class="sub" type="submit" value="Submit" name="submit" style="border-color:lightseagreen;padding:10px;border-radius:5px;color:lightseagreen">
        </td>
    </tr>
